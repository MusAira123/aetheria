      ...
      <header className="bg-black text-white px-6 md:px-12 py-0 rounded-b-3xl">
        ...
        <div className="flex justify-between items-center">
          ...
          <nav className="flex gap-8 text-sm md:text-base font-medium tracking-wide">
            ...
            <a href="#shop" className="hover:text-yellow-400 transition">Products</a>
            <a href="#story" className="hover:text-yellow-400 transition">Our Story</a>
      ...
      <section className="px-6 md:px-12 py-20 grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex gap-4">
            ...
            <a href="https://wa.me/919028513130" className="border px-6 py-3 rounded-lg">
              WhatsApp Us
            </a>
          </div>
          ...
          {products.map((p) => (
            <div key={p.id} className="border rounded-xl overflow-hidden hover:shadow-lg transition hover:scale-[1.02]">
              ...
              <div className="p-4">
                ...
                <p className="font-bold mt-3">₹{p.price}</p>
        ...
        <div className="grid md:grid-cols-4 gap-30">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-4">
              <a href="https://www.instagram.com/_aetheria___">Instagram</a>
              <a href="https://wa.me/919028513130">WhatsApp</a>
            </div>
          </div>
